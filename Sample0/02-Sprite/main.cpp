...
void LoadResources()
{
	...
	sprites->Add(20001, 300, 136, 317, 152, texMisc);
	sprites->Add(20002, 318, 136, 335, 152, texMisc);
	sprites->Add(20003, 336, 136, 353, 152, texMisc);
	sprites->Add(20004, 354, 136, 371, 152, texMisc);
	...
	sprites->Add(30001, 6, 130, 22, 158, texEnemy);
	sprites->Add(30002, 28, 130, 44, 158, texEnemy);
	sprites->Add(30003, 50, 130, 66, 158, texEnemy);
	sprites->Add(30004, 72, 130, 88, 158, texEnemy);
