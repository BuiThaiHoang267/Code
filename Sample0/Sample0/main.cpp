...
#define BACKGROUND_COLOR D3DXCOLOR(0.1f, 0.1f, 0.1f, 0.999f)
...
void Update(DWORD dt)
{
	...
	float right_edge = BackBufferWidth - BRICK_WIDTH + 16;
	float bottom_edge = BackBufferHeight - BRICK_HEIGHT + 16;
